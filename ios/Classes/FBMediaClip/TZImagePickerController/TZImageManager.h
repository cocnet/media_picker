...
@property (nonatomic, assign) NSInteger videoCanPickLimitSize;
@property (nonatomic, assign) NSInteger imageCanPickLimitSize;
@property (nonatomic, assign) NSInteger imageCanPickLimitPixel;
