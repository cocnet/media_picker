...
public class MediaThumbData {
    ...
    public MediaThumbData(String identify, String fileType, boolean thumb, Context context) {
            ...
            public void run() {
                try {
                    ...
                    if (fileType.contains("video")) {
                        Bitmap bitmap = MediaStore.Video.Thumbnails.getThumbnail(context.getContentResolver(), Long.parseLong(identify), thumb ? MediaStore.Images.Thumbnails.MINI_KIND : MediaStore.Images.Thumbnails.FULL_SCREEN_KIND, null);
                        ...
                        if (!TextUtils.isEmpty(originPath) && isPNG) {
                            ...
                            bitmap = MediaStore.Images.Thumbnails.getThumbnail(context.getContentResolver(), Long.parseLong(identify), thumb ? MediaStore.Images.Thumbnails.MINI_KIND : MediaStore.Images.Thumbnails.FULL_SCREEN_KIND, null);
                        }
                        ByteArrayOutputStream stream = new ByteArrayOutputStream();
