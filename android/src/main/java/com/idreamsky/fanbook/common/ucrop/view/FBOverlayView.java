 ...
 */
public class FBOverlayView extends View {
    ...
    private FBOverlayViewChangeListener mCallback;
    ...
    public FBOverlayView(Context context) {
        this(context, null);
    }

    public FBOverlayView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FBOverlayView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public FBOverlayViewChangeListener getOverlayViewChangeListener() {
        return mCallback;
    }

    public void setOverlayViewChangeListener(FBOverlayViewChangeListener callback) {
        mCallback = callback;
    }
    ...
    private void updateGridPoints() {
        mCropGridCorners = FBRectUtils.getCornersFromRect(mCropViewRect);
        mCropGridCenter = FBRectUtils.getCenterFromRect(mCropViewRect);
