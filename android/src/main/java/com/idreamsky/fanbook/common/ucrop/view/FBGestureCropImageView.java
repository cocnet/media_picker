...
import com.idreamsky.fanbook.common.ucrop.util.FBRotationGestureDetector;

/**
 * Created by Oleksii Shliama (https://github.com/shliama).
 */
public class FBGestureCropImageView extends FBCropImageView {

    private static final int DOUBLE_TAP_ZOOM_DURATION = 200;

    private ScaleGestureDetector mScaleDetector;
    private FBRotationGestureDetector mRotateDetector;
    ...
    public FBGestureCropImageView(Context context) {
        super(context);
    }

    public FBGestureCropImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FBGestureCropImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setupGestureListeners() {
        ...
        mRotateDetector = new FBRotationGestureDetector(new RotateListener());
    }
    ...
    private class RotateListener extends FBRotationGestureDetector.SimpleOnRotationGestureListener {

        @Override
        public boolean onRotation(FBRotationGestureDetector rotationDetector) {
