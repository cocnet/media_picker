package com.idreamsky.fanbook.common.ucrop.view.widget;
...
import com.idreamsky.fanbook.common.ucrop.model.FBAspectRatio;
import com.idreamsky.fanbook.common.ucrop.view.FBCropImageView;
 ...
 */
public class FBAspectRatioTextView extends AppCompatTextView {
    ...
    public FBAspectRatioTextView(Context context) {
        this(context, null);
    }

    public FBAspectRatioTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FBAspectRatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setAspectRatio(@NonNull FBAspectRatio aspectRatio) {
        ...
        if (mAspectRatioX == FBCropImageView.SOURCE_IMAGE_ASPECT_RATIO || mAspectRatioY == FBCropImageView.SOURCE_IMAGE_ASPECT_RATIO) {
            mAspectRatio = FBCropImageView.SOURCE_IMAGE_ASPECT_RATIO;
        } else {
    ...
    private void init(@NonNull TypedArray a) {
        ...
        mAspectRatioX = a.getFloat(R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_x, FBCropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        mAspectRatioY = a.getFloat(R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_y, FBCropImageView.SOURCE_IMAGE_ASPECT_RATIO);
    ...
    private void toggleAspectRatio() {
        if (mAspectRatio != FBCropImageView.SOURCE_IMAGE_ASPECT_RATIO) {
