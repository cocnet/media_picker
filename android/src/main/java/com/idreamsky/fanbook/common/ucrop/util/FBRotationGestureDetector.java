...
public class FBRotationGestureDetector {
    ...
    public FBRotationGestureDetector(OnRotationGestureListener listener) {
        mListener = listener;
    ...
    public interface OnRotationGestureListener {
        ...
        boolean onRotation(FBRotationGestureDetector rotationDetector);
    }
